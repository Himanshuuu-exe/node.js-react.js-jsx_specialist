...
exports.processRequest=function(request,response) 
{
    ...
    response.write("</head>"); 
    response.write("<body>");
    response.write("<h1>Administrator Account</h1>");
    response.write("<div style='color:red'>");
    
    if(username.length==0) response.write("Username required<br>");
    if(username.length==0) response.write("Password required<br>");
    else if(password!=repassword) response.write("Password typed incorrectly");
    response.write("</div>");
    ...
    response.write("<td><input type='repassword' id='repassword' name='repassword' maxlength='15' size='16'></td>");
    response.write("</tr>");
    response.write("<tr>");
